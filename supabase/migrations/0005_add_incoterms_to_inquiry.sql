-- Add incoterms to inquiry table and fix quotation structure
...
ALTER TABLE "quotation_charge" ADD COLUMN IF NOT EXISTS "charge_name" text;
ALTER TABLE "quotation_charge" ADD COLUMN IF NOT EXISTS "unit" text;
ALTER TABLE "quotation_charge" ADD COLUMN IF NOT EXISTS "location" text;
ALTER TABLE "quotation_charge" ADD COLUMN IF NOT EXISTS "is_optional" boolean DEFAULT false;
