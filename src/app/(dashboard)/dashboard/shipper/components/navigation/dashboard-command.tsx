...
import { SEARCH_FUNCTIONALITY_LIST_SHIPPER } from "@/lib/constants/search-functionality-list-shipper";
...
const functionalityActions = SEARCH_FUNCTIONALITY_LIST_SHIPPER;
...
export const DashboardCommand = ({ open, setOpen }: Props) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className={cn("overflow-hidden p-0 max-w-lg")} showCloseButton>
        {commandContent}
      </DialogContent>
    </Dialog>
  );
