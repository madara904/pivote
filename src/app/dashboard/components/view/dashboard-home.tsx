...
import { Star, FileText, DollarSign, Package, TrendingUp, Search, HelpCircle, Eye, Users, Plus } from "lucide-react"
  ...
  return (
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Spedition & Logistik</p>
          </div>
        </div>
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card className="relative overflow-hidden">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-accent-foreground p-3.5 py-2 rounded-full inline-block bg-secondary">12</div>
        </CardContent>
      </Card>
      ...
      <Card className="relative overflow-hidden">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-accent-foreground p-3.5 py-2 rounded-full inline-block bg-secondary">8</div>
        </CardContent>
      </Card>
      ...
      <Card className="relative overflow-hidden">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-accent-foreground p-3.5 py-2 rounded-full inline-block bg-secondary">23</div>
        </CardContent>
      </Card>
      ...
      <Card className="relative overflow-hidden">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-accent-foreground p-3.5 py-2 rounded-full inline-block bg-secondary">28.450 €</div>
        </CardContent>
      </Card>
    </div>
              ...
              <div className="group cursor-pointer rounded-lg border p-4 hover:bg-muted/50 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Auf Anfragen antworten</p>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <div className="group cursor-pointer rounded-lg border p-4 hover:bg-muted/50 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Fortschritt überwachen</p>
                </div>
              </div>
            </div>
            ...
            <div className="group cursor-pointer rounded-lg border p-4 hover:bg-muted/50 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Hilfe kontaktieren</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="grid gap-6 lg:grid-cols-3">
            ...
            <TableBody>
              <TableRow className="hover:bg-muted/50">
                ...
                <TableCell>
                  <div className="text-sm">
                    <div>Elektronik</div>
                    <div className="text-muted-foreground">12 Stk • 450 kg</div>
                  </div>
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-muted/50">
              ...
              <TableRow className="hover:bg-muted/50">
                ...
                <TableCell>
                  <div className="text-sm">
                    <div>Textilien</div>
                    <div className="text-muted-foreground">8 Stk • 180 kg</div>
                  </div>
                </TableCell>
              </TableRow>
            </TableBody>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Ihre wichtigsten Kennzahlen diesen Monat</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">+5% vom letzten Monat</p>
          </div>
